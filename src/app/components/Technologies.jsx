...
const CategoryButton = ({ color, hoverColor, label, onHover, onLeave }) => (
  <button
    ...
    <section className="relative py-16">
      <div className="absolute inset-0 bg-[#FFCC00]">
        {[...Array(20)].map((_, i) => (
          <div 
            key={i}
            className="absolute bg-black/5 rounded"
            style={{
      ...
      <div className="relative max-w-7xl mx-auto px-4">
        <div className="relative mb-16 inline-block">
          <h2 className="text-4xl font-black tracking-tight text-black before:absolute before:inset-0 before:bg-[#FFCC00] before:translate-x-1 before:translate-y-1 before:-z-10 after:absolute after:inset-0 after:bg-black/10 after:translate-x-2 after:translate-y-2 after:-z-20">
            TECHNOLOGIES
          </h2>
