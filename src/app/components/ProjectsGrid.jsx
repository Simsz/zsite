...
const ProjectsGrid = () => {
    const projects = [
      {
        title: "TinyPM",
        description: "Quick and easy server management with Pterodactyl Panel in Docker-compose stacks.",
      ...
      {
        title: "Liar's Bar",
        description: "Web based version of Russian Roulette, built with HTML5, CSS3 and Javascript.",
      ...
      {
        title: "Martine",
        description: "Proof of concept website for a local bar using Astro, React and TailwindCSS.",
